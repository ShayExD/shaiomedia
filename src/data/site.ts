...
export const site = {
  ...
  description:
    "בונים אתרים ומקדמים אורגנית עסקי שירות בארצות הברית. בנייה ושיפוצים, גגות, ארובות, מנעולנות ודלתות גראז׳.",
};
...
export const includes = [
  {
    ...
    items: [
      ...
      "סקשן המלצות שמושך ביקורות מגוגל",
      "כפתור חיוג וטופס השארת פרטים בכל מסך",
    ],
  },
  {
    n: "02",
    ...
    items: [
      ...
      "התאמה מלאה בין האתר לפרופיל במפות: שם, כתובת, שירותים ואזורי שירות זהים",
      "תוכן חדש כל חודש",
  ...
  },
  {
    ...
    items: [
      ...
      "הדומיין רשום על שמכם, והאתר שלכם אם תרצו לקחת אותו",
    ],
  },
];
...
export const edge = [
  {
    ...
    body: "רוב הלקוחות שלנו יושבים בלאס וגאס, לוס אנג׳לס, סיאטל, פורטלנד, סן חוזה וצפון קרוליינה, ואנחנו שולטים ברוב מקצועות השירות. מהניסיון הזה אנחנו כבר יודעים איך נראה חיפוש של בעל בית שם, ולכן קל לנו לכתוב תוכן שמדבר בדיוק לחיפושים האלה.",
  },
  {
    title: "שני מתכנתים, לא שני משווקים",
    body: "שנינו בוגרי מדעי המחשב. כשצריך לתקן משהו באתר, לשנות מבנה או לבנות מהר, זה נעשה אצלנו ולא אצל ספק שלישי.",
  },
  {
    title: "נמדדים בשיחות, לא במיקומים",
    body: "מיקום ראשון על ביטוי שאף אחד לא מחפש לא שווה כלום. הדוח החודשי מדבר על כמה פניות נכנסו.",
  },
  {
    title: "האתר שלכם",
    body: "הדומיין רשום על שמכם מהיום הראשון. האתר מתארח אצלנו, ואם תרצו לקחת אותו לספק אחר הוא שלכם ואנחנו מעבירים אותו עם גישה מלאה.",
  },
];
...
export const faq = [
  ...
  },
  {
    ...
    a: "אתם לא נשארים תקועים. הדומיין רשום על שמכם מהיום הראשון, והאתר שלכם. הוא מתארח אצלנו, ואם תרצו לקחת אותו לכל אחסון אחר אנחנו מעבירים אותו עם גישה מלאה, בלי להחזיק אף אחד כבן ערובה.",
  },
];
